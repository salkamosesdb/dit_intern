...
const EditTea=()=>{
    ...
    const submitHandler=async(e)=>{
        ...
        const res=await axios.put('http://localhost:5000/login/teacher/teacherdashboard/update_teacher_profile',{...registerData})
                    ...
                    <div className="row">
                        <div className="form-group col-md-6 ">
                            ...
                            <input className="form-control border border-primary input-lg" type="text" name="classes"
                                id="classes" placeholder="" onChange={inputHandler} value={registerData.classes}/>
